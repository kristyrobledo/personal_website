...
**AMENDMENT**
After trying for ages to figure out why my homepage was blank, it was pointed out to me on Slack that blogdown::serve_site() is superior to build_site(). So at the end of all of this, open a fresh Rstudio and serve_site and upload that public directory for success!
